...
interface MeerkatTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setReleaseBlock(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setReleaseBlock",
...
export class MeerkatToken extends Contract {
  ...
  interface: MeerkatTokenInterface;
  ...
  functions: {
    ...
    "setReleaseBlock(uint256,uint256)"(
      _startReleaseBlock: BigNumberish,
      _endReleaseBlock: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
